...
int main(int argc, char** argv) {
	...
	Level* l = new Level();
	//Level* ll = new Level(); 
	shared_ptr<Player> player = Player::getInstance(300, 300, 100, 100, "assets/1.png", enableMouseXandY,0, e);
	...
	l->background = "assets/2.bmp";
	void(Player::*pek)() = &Player::kill;
	Player* p = player.get();
	//e.installCommand(pek, p, SDLK_SPACE);
